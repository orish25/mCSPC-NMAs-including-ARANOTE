...
cross_hr_re_discont_AE_sens <- cross_effect(bugs_object = bugs_object_re, t_names = c("ADT", "DAR+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_re_discont_AE_sens, file = "cross_hr_re_discont_AE_sens.csv")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("ADT", "DAR+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT"))
