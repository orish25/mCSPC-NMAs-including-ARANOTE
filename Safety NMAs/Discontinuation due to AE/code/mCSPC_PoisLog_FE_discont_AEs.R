...
cross_meandiff_fe_discont_AEs <- cross_effect(bugs_object = bugs_object_fe, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_discont_AEs, file = "cross_meandiff_fe_discont_AEs.csv")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZA+ADT", "ABI+ADT", "APA+ADT", "ABI+DOC+ADT"))
