...
ns <- nrow(mCSPC_grade_3_5)
nt <- max(mCSPC_grade_3_5$t1)
t  <- array(c(mCSPC_grade_3_5$t1, mCSPC_grade_3_5$t2), dim = c(ns, 2)) 
r  <- array(c(mCSPC_grade_3_5$r1, mCSPC_grade_3_5$r2), dim = c(ns, 2)) 
n  <- array(c(mCSPC_grade_3_5$n1, mCSPC_grade_3_5$n2), dim = c(ns, 2))
E <- array(c(mCSPC_grade_3_5$E1, mCSPC_grade_3_5$E2), dim = c(ns, 2))
...
cross_hr_re_grade3 <- cross_effect(bugs_object = bugs_object_re, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZA+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_re_grade3, file = "cross_hr_re_grade3.csv")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZA+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT"))
