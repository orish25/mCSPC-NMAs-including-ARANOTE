...
cross_hr_os_doublet_TTD <- cross_effect(bugs_object = bugs_object_re, t_names = c("ADT", "DAR+ADT", "ENZ+ADT", "APA+ADT", "ABI+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_os_doublet_TTD, file = "cross_hr_os_doublet_TTD")
