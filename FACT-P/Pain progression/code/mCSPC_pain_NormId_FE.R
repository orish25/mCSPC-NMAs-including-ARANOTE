...
cross_meandiff_fe_pain <- cross_effect(bugs_object = bugs_object_fe, t_names = c("ADT", "DAR+ADT", "ENZ+ADT", "APA+ADT", "ABI+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_pain, file = "cross_meandiff_fe_pain.csv")
