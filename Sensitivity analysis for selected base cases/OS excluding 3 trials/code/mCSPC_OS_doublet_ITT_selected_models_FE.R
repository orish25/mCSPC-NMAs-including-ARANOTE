...
ns <- nrow(mCSPC_OS_doublet_ITT_selected_models)
t  <- array(c(mCSPC_OS_doublet_ITT_selected_models$t1, mCSPC_OS_doublet_ITT_selected_models$t2), dim = c(ns, 2)) 
nt <- max(t) 
y  <- array(c(rep(0, ns), mCSPC_OS_doublet_ITT_selected_models$y), dim = c(ns, 2))
se <- array(c(rep(0, ns), mCSPC_OS_doublet_ITT_selected_models$se), dim = c(ns, 2))

study_names <- gsub("#", "", mCSPC_OS_doublet_ITT_selected_models$`#ID`)
...
cross_hr_os_doublet_select_fe <- cross_effect(bugs_object = bugs_object_fe_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_os_doublet_select_fe, file = "cross_hr_os_doublet_select_fe.csv")
...
calculate_sucra(bugs_object = bugs_object_fe_mams, bugs_data = bugs_data_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT"))
