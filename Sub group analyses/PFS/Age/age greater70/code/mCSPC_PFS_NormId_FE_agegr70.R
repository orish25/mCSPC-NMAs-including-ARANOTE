...
cross_doublet_fe_pfs_agegr70 <- cross_effect(bugs_object = bugs_object_fe, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ABI+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_doublet_fe_pfs_agegr70, file = "cross_doublet_fe_pfs_agegr70")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ABI+ADT"))
