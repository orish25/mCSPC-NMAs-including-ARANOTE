...
ns <- nrow(mCSPC_PFS_data_denovo)
t  <- array(c(mCSPC_PFS_data_denovo$t1, mCSPC_PFS_data_denovo$t2), dim = c(ns, 2)) 
nt <- max(t) 
y  <- array(c(rep(0, ns), mCSPC_PFS_data_denovo$y), dim = c(ns, 2))
se <- array(c(rep(0, ns), mCSPC_PFS_data_denovo$se), dim = c(ns, 2))
...
cross_hr_doublet_re_pfs_denovo <- cross_effect(bugs_object = bugs_object_re, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ABI+ADT", "APA+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_doublet_re_pfs_denovo, file = "cross_hr_doublet_re_pfs_denovo")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ABI+ADT", "APA+ADT", "ABI+DOC+ADT"))


# Define your treatment names
treatment_names <- c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ABI+ADT", "APA+ADT", "ABI+DOC+ADT")
