...
cross_doublet_fe_pfs_gleasonless8 <- cross_effect(bugs_object = bugs_object_fe, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_doublet_fe_pfs_gleasonless8, file = "cross_doublet_fe_pfs_gleasonless")
