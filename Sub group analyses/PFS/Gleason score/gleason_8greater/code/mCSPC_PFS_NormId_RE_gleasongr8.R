...
cross_hr_doublet_re_pfs_gleasongr8 <- cross_effect(bugs_object = bugs_object_re, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_doublet_re_pfs_gleasongr8, file = "cross_hr_doublet_re_pfs_gleasongr8")
