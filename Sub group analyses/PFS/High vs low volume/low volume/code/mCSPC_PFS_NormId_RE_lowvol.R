...
cross_hr_doublet_re_pfs_lowvol <- cross_effect(bugs_object = bugs_object_re, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "APA+ADT", "ABI+DOC+ADT", "ABI+ADT", "SNA+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_doublet_re_pfs_lowvol, file = "cross_hr_doublet_re_pfs_lowvol")
