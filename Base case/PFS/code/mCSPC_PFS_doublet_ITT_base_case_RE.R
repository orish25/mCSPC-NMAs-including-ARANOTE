...
cross_hr_doublet_re_pfs_base_case <- cross_effect(bugs_object = bugs_object_re_mams, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_doublet_re_pfs_base_case, file = "cross_hr_doublet_re_pfs_base_case")
