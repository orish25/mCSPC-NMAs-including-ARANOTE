...
ns <- nrow(mCSPC_PFS_doublet_ITT_base_case)
t  <- array(c(mCSPC_PFS_doublet_ITT_base_case$t1, mCSPC_PFS_doublet_ITT_base_case$t2), dim = c(ns, 2)) 
nt <- max(t) 
y  <- array(c(rep(0, ns), mCSPC_PFS_doublet_ITT_base_case$y), dim = c(ns, 2))
se <- array(c(rep(0, ns), mCSPC_PFS_doublet_ITT_base_case$se), dim = c(ns, 2))

study_names <- gsub("#", "", mCSPC_PFS_doublet_ITT_base_case$`#ID`)
...
cross_doublet_fe_pfs_base_case <- cross_effect(bugs_object = bugs_object_fe_mams, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_doublet_fe_pfs_base_case, file = "cross_doublet_fe_pfs_base_case")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT"))
calculate_sucra(bugs_object = bugs_object_fe_mams, bugs_data = bugs_data_mams, t_names = c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT"))


# Define your treatment names
treatment_names <- c("ADT", "DAR+ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "SNA+ADT", "ABI+DOC+ADT")
