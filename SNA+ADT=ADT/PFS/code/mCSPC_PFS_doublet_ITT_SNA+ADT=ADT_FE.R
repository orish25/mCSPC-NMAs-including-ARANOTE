...
ns <- nrow(mCSPC_PFS_doublet_ITT_SNA_ADT_ADT)
t  <- array(c(mCSPC_PFS_doublet_ITT_SNA_ADT_ADT$t1, mCSPC_PFS_doublet_ITT_SNA_ADT_ADT$t2), dim = c(ns, 2)) 
nt <- max(t) 
y  <- array(c(rep(0, ns), mCSPC_PFS_doublet_ITT_SNA_ADT_ADT$y), dim = c(ns, 2))
se <- array(c(rep(0, ns), mCSPC_PFS_doublet_ITT_SNA_ADT_ADT$se), dim = c(ns, 2))

study_names <- gsub("#", "", mCSPC_PFS_doublet_ITT_SNA_ADT_ADT$`#ID`)
...
cross_doublet_fe_pfs_ADT_only <- cross_effect(bugs_object = bugs_object_fe_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_doublet_fe_pfs_ADT_only, file = "cross_doublet_fe_pfs_ADT_only")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"))
calculate_sucra(bugs_object = bugs_object_fe_mams, bugs_data = bugs_data_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"))


# Define your treatment names
treatment_names <- c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT")
...
d_samples <- bugs_object_fe_mams$sims.array[, , grep("^d\\[", dimnames(bugs_object_fe_mams$sims.array)[[3]])]
...
posterior_samples <- bugs_object_fe_mams$sims.array[, , grep("^d\\[", rownames(bugs_object_fe_mams$summary))]
