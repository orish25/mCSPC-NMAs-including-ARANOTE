...
cross_hr_doublet_re_pfs_ADT_only <- cross_effect(bugs_object = bugs_object_re_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_doublet_re_pfs_ADT_only, file = "cross_hr_doublet_re_pfs_ADT_only")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"))
calculate_sucra(bugs_object = bugs_object_re_mams, bugs_data = bugs_data_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"))
