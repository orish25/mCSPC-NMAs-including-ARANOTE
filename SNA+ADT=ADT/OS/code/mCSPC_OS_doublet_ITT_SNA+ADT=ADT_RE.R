...
cross_hr_os_doublet_ADT_only_re <- cross_effect(bugs_object = bugs_object_re_mams, t_names = c("DAR+ADT", "ADT", "DAR+DOC+ADT", "DOC+ADT", "ENZ+ADT", "ABI+ADT", "APA+ADT", "ENZ+DOC+ADT", "ABI+DOC+ADT"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_os_doublet_ADT_only_re, file = "cross_hr_os_doublet_ADT_only_re")
